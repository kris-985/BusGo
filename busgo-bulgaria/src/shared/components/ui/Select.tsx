  ...
  return (
    <label className="block">
      ...
      <select
        ...
        id={selectId}
        className={cn(
          'h-12 w-full appearance-none rounded-lg border border-slate-300 bg-white px-3.5 text-slate-950 shadow-sm dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100',
