...
export function AiAssistant() {
  ...
  return (
    <div className="pointer-events-none fixed bottom-[calc(1rem+env(safe-area-inset-bottom))] right-3 z-50 w-fit max-w-[calc(100vw-1.5rem)] sm:bottom-6 sm:right-6 sm:max-w-none">
      <div
        className={cn(
      ...
      <button
        type="button"
        className="pointer-events-auto ml-auto flex h-12 items-center gap-2 rounded-2xl bg-slate-950 px-3 font-black text-white shadow-[0_18px_45px_rgba(15,23,42,0.25)] transition-transform hover:-translate-y-0.5 sm:h-14 sm:gap-3 sm:px-4"
